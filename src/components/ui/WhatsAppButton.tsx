...
export function WhatsAppButton({ numero = process.env.NEXT_PUBLIC_WHATSAPP_SUPPORT ?? "24100000000" }: { numero?: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#1EBE5C] text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all active:scale-90"
    >
