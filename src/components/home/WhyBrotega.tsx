...
export function WhyJadoreLaFamille() {
  return (
    <section className="bg-white py-14">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-black text-gray-800">Pourquoi choisir J&apos;adore la Famille ?</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {features.map((f) => (
            <div key={f.title} className="text-center p-5 rounded-2xl hover:bg-[#FEF2F2] transition-colors group">
