  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Big promo */}
        <div className="md:col-span-2 bg-gradient-to-br from-[#E63946] to-[#004d26] rounded-3xl p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link href="/catalogue?promo=1" className="inline-flex items-center gap-2 bg-white text-[#E63946] font-bold px-5 py-2.5 rounded-xl hover:bg-[#FEF2F2] transition-colors text-sm" aria-label="Voir les promotions">
              Profiter maintenant →
            </Link>
          </div>
        </div>
