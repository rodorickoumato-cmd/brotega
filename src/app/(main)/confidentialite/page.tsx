    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
        {[
          ...
          {
            title: "6. Vos droits",
            content: "Conformément à la législation en vigueur, vous disposez d'un droit d'accès, de rectification et de suppression de vos données personnelles. Pour exercer ces droits, contactez-nous à : privacy@brotega.ga ou via notre service client.",
          },
          {
        ...
        <div className="bg-[#E8F7EE] rounded-2xl p-5 text-center">
          <p className="text-[#00A550] font-semibold mb-2">Questions sur vos données personnelles ?</p>
